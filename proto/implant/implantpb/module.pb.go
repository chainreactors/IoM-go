...
var file_implant_implantpb_module_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x73, 0x41, 0x72, 0x72, 0x61, 0x79, 0x42, 0x39, 0x5a, 0x37, 0x67, 0x69, 0x74, 0x68,
	...
	0x6f, 0x2f, 0x69, 0x6d, 0x70, 0x6c, 0x61, 0x6e, 0x74, 0x2f, 0x69, 0x6d, 0x70, 0x6c, 0x61, 0x6e,
...
var file_implant_implantpb_module_proto_msgTypes = make([]protoimpl.MessageInfo, 75)
var file_implant_implantpb_module_proto_goTypes = []interface{}{
	...
	nil,                           // 68: modulepb.Request.ParamsEntry
	nil,                           // 69: modulepb.Response.KvEntry
	nil,                           // 70: modulepb.ExecuteBinary.ParamEntry
	nil,                           // 71: modulepb.CurlRequest.HeaderEntry
	nil,                           // 72: modulepb.WmiMethodRequest.ParamsEntry
	nil,                           // 73: modulepb.PtyRequest.ParamsEntry
	nil,                           // 74: modulepb.PtyResponse.MetadataEntry
}
var file_implant_implantpb_module_proto_depIdxs = []int32{
	...
	68, // 6: modulepb.Request.params:type_name -> modulepb.Request.ParamsEntry
	69, // 7: modulepb.Response.kv:type_name -> modulepb.Response.KvEntry
	...
	70, // 14: modulepb.ExecuteBinary.param:type_name -> modulepb.ExecuteBinary.ParamEntry
	...
	71, // 17: modulepb.CurlRequest.header:type_name -> modulepb.CurlRequest.HeaderEntry
	...
	72, // 26: modulepb.WmiMethodRequest.params:type_name -> modulepb.WmiMethodRequest.ParamsEntry
	58, // 27: modulepb.PipeRequest.pipe:type_name -> modulepb.Pipe
	62, // 28: modulepb.TaskListResponse.tasks:type_name -> modulepb.TaskInfo
	73, // 29: modulepb.PtyRequest.params:type_name -> modulepb.PtyRequest.ParamsEntry
	74, // 30: modulepb.PtyResponse.metadata:type_name -> modulepb.PtyResponse.MetadataEntry
