...
type Modules struct {
	...
	BundleMap     map[string]string      `protobuf:"bytes,2,rep,name=bundle_map,json=bundleMap,proto3" json:"bundle_map,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ExecuteBinary struct {
	...
	Name          string                 `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	Bin           []byte                 `protobuf:"bytes,2,opt,name=bin,proto3" json:"bin,omitempty"`
	Param         map[string]string      `protobuf:"bytes,3,rep,name=param,proto3" json:"param,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
