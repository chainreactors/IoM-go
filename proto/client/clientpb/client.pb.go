...
var file_client_clientpb_client_proto_rawDesc = []byte{
	...
	0x08, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x78, 0x74, 0x73, 0x22, 0x49, 0x0a, 0x07, 0x4b, 0x65, 0x79,
	...
	,
...
var file_client_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 100)
var file_client_clientpb_client_proto_goTypes = []interface{}{
	...
	(*KeyPair)(nil),                 // 89: clientpb.KeyPair
	(*Secure)(nil),                  // 90: clientpb.Secure
	nil,                             // 91: clientpb.Session.ArgueEntry
	nil,                             // 92: clientpb.Session.LootEntry
	nil,                             // 93: clientpb.Job.ContentsEntry
	nil,                             // 94: clientpb.AcmeConfig.CredentialsEntry
	nil,                             // 95: clientpb.AcmeRequest.CredentialsEntry
	nil,                             // 96: clientpb.REM.AgentsEntry
	nil,                             // 97: clientpb.Website.ContentsEntry
	nil,                             // 98: clientpb.GithubActionBuildConfig.InputsEntry
	nil,                             // 99: clientpb.SaasBuildConfig.HeadersEntry
	(*implantpb.Os)(nil),            // 100: modulepb.Os
	(*implantpb.Process)(nil),       // 101: modulepb.Process
	(*implantpb.Timer)(nil),         // 102: modulepb.Timer
	(*implantpb.Addon)(nil),         // 103: modulepb.Addon
	(*implantpb.Spite)(nil),         // 104: implantpb.Spite
	(*implantpb.Register)(nil),      // 105: modulepb.Register
}
var file_client_clientpb_client_proto_depIdxs = []int32{
	31,  // 0: clientpb.Session.tasks:type_name -> clientpb.Tasks
	100, // 1: clientpb.Session.os:type_name -> modulepb.Os
	101, // 2: clientpb.Session.process:type_name -> modulepb.Process
	102, // 3: clientpb.Session.timer:type_name -> modulepb.Timer
	103, // 4: clientpb.Session.addons:type_name -> modulepb.Addon
	89,  // 5: clientpb.Session.key_pair:type_name -> clientpb.KeyPair
	91,  // 6: clientpb.Session.argue:type_name -> clientpb.Session.ArgueEntry
	92,  // 7: clientpb.Session.loot:type_name -> clientpb.Session.LootEntry
	27,  // 8: clientpb.Audit.context:type_name -> clientpb.TaskContext
	104, // 9: clientpb.Audit.request:type_name -> implantpb.Spite
	...
	104, // 13: clientpb.SpiteCacheItem.spite:type_name -> implantpb.Spite
	54,  // 14: clientpb.Job.pipeline:type_name -> clientpb.Pipeline
	93,  // 15: clientpb.Job.contents:type_name -> clientpb.Job.ContentsEntry
	...
	104, // 31: clientpb.Event.spite:type_name -> implantpb.Spite
	...
	104, // 36: clientpb.TaskContext.spite:type_name -> implantpb.Spite
	30,  // 37: clientpb.TaskContexts.task:type_name -> clientpb.Task
	3,   // 38: clientpb.TaskContexts.session:type_name -> clientpb.Session
	104, // 39: clientpb.TaskContexts.spites:type_name -> implantpb.Spite
	...
	105, // 48: clientpb.RegisterSession.register_data:type_name -> modulepb.Register
	...
	104, // 52: clientpb.SpiteRequest.spite:type_name -> implantpb.Spite
	104, // 53: clientpb.SpiteResponse.spite:type_name -> implantpb.Spite
	...
	90,  // 57: clientpb.Pipeline.secure:type_name -> clientpb.Secure
	...
	94,  // 69: clientpb.AcmeConfig.credentials:type_name -> clientpb.AcmeConfig.CredentialsEntry
	95,  // 70: clientpb.AcmeRequest.credentials:type_name -> clientpb.AcmeRequest.CredentialsEntry
	96,  // 71: clientpb.REM.agents:type_name -> clientpb.REM.AgentsEntry
	67,  // 72: clientpb.REMAgents.agents:type_name -> clientpb.REMAgent
	97,  // 73: clientpb.Website.contents:type_name -> clientpb.Website.ContentsEntry
	...
	98,  // 81: clientpb.GithubActionBuildConfig.inputs:type_name -> clientpb.GithubActionBuildConfig.InputsEntry
	99,  // 82: clientpb.SaasBuildConfig.headers:type_name -> clientpb.SaasBuildConfig.HeadersEntry
	...
	89,  // 89: clientpb.Secure.server_keypair:type_name -> clientpb.KeyPair
	89,  // 90: clientpb.Secure.implant_keypair:type_name -> clientpb.KeyPair
	71,  // 91: clientpb.Job.ContentsEntry.value:type_name -> clientpb.WebContent
	67,  // 92: clientpb.REM.AgentsEntry.value:type_name -> clientpb.REMAgent
	71,  // 93: clientpb.Website.ContentsEntry.value:type_name -> clientpb.WebContent
