...
var file_client_clientpb_client_proto_rawDesc = []byte{
	...
	0x63, 0x65, 0x22, 0xd6, 0x04, 0x0a, 0x0b, 0x42, 0x75, 0x69, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66,
	...
	0x79, 0x70, 0x61, 0x69, 0x72, 0x42, 0x37, 0x5a, 0x35, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e,
...
var file_client_clientpb_client_proto_msgTypes = make([]protoimpl.MessageInfo, 105)
var file_client_clientpb_client_proto_goTypes = []interface{}{
	...
	(*BuildConfig)(nil),             // 79: clientpb.BuildConfig
	(*BuildResources)(nil),          // 80: clientpb.BuildResources
	(*ResourceEntry)(nil),           // 81: clientpb.ResourceEntry
	(*DockerBuildConfig)(nil),       // 82: clientpb.DockerBuildConfig
	(*GithubActionBuildConfig)(nil), // 83: clientpb.GithubActionBuildConfig
	(*SaasBuildConfig)(nil),         // 84: clientpb.SaasBuildConfig
	(*SaasConfig)(nil),              // 85: clientpb.SaasConfig
	(*GithubWorkflowConfig)(nil),    // 86: clientpb.GithubWorkflowConfig
	(*GithubWorkflows)(nil),         // 87: clientpb.GithubWorkflows
	(*GithubWorkflow)(nil),          // 88: clientpb.GithubWorkflow
	(*LicenseInfo)(nil),             // 89: clientpb.LicenseInfo
	(*Notify)(nil),                  // 90: clientpb.Notify
	(*Context)(nil),                 // 91: clientpb.Context
	(*Contexts)(nil),                // 92: clientpb.Contexts
	(*ContextChunk)(nil),            // 93: clientpb.ContextChunk
	(*KeyPair)(nil),                 // 94: clientpb.KeyPair
	(*Secure)(nil),                  // 95: clientpb.Secure
	nil,                             // 96: clientpb.Session.ArgueEntry
	nil,                             // 97: clientpb.Session.LootEntry
	nil,                             // 98: clientpb.Job.ContentsEntry
	nil,                             // 99: clientpb.AcmeConfig.CredentialsEntry
	nil,                             // 100: clientpb.AcmeRequest.CredentialsEntry
	nil,                             // 101: clientpb.REM.AgentsEntry
	nil,                             // 102: clientpb.Website.ContentsEntry
	nil,                             // 103: clientpb.GithubActionBuildConfig.InputsEntry
	nil,                             // 104: clientpb.SaasBuildConfig.HeadersEntry
	(*implantpb.Os)(nil),            // 105: modulepb.Os
	(*implantpb.Process)(nil),       // 106: modulepb.Process
	(*implantpb.Timer)(nil),         // 107: modulepb.Timer
	(*implantpb.Addon)(nil),         // 108: modulepb.Addon
	(*implantpb.Spite)(nil),         // 109: implantpb.Spite
	(*implantpb.Register)(nil),      // 110: modulepb.Register
}
var file_client_clientpb_client_proto_depIdxs = []int32{
	31,  // 0: clientpb.Session.tasks:type_name -> clientpb.Tasks
	105, // 1: clientpb.Session.os:type_name -> modulepb.Os
	106, // 2: clientpb.Session.process:type_name -> modulepb.Process
	107, // 3: clientpb.Session.timer:type_name -> modulepb.Timer
	108, // 4: clientpb.Session.addons:type_name -> modulepb.Addon
	94,  // 5: clientpb.Session.key_pair:type_name -> clientpb.KeyPair
	96,  // 6: clientpb.Session.argue:type_name -> clientpb.Session.ArgueEntry
	97,  // 7: clientpb.Session.loot:type_name -> clientpb.Session.LootEntry
	27,  // 8: clientpb.Audit.context:type_name -> clientpb.TaskContext
	109, // 9: clientpb.Audit.request:type_name -> implantpb.Spite
	...
	109, // 13: clientpb.SpiteCacheItem.spite:type_name -> implantpb.Spite
	57,  // 14: clientpb.Job.pipeline:type_name -> clientpb.Pipeline
	98,  // 15: clientpb.Job.contents:type_name -> clientpb.Job.ContentsEntry
	...
	109, // 31: clientpb.Event.spite:type_name -> implantpb.Spite
	...
	109, // 36: clientpb.TaskContext.spite:type_name -> implantpb.Spite
	30,  // 37: clientpb.TaskContexts.task:type_name -> clientpb.Task
	3,   // 38: clientpb.TaskContexts.session:type_name -> clientpb.Session
	109, // 39: clientpb.TaskContexts.spites:type_name -> implantpb.Spite
	...
	80,  // 48: clientpb.Profile.resources:type_name -> clientpb.BuildResources
	50,  // 49: clientpb.Profiles.profiles:type_name -> clientpb.Profile
	110, // 50: clientpb.RegisterSession.register_data:type_name -> modulepb.Register
	...
	109, // 54: clientpb.SpiteRequest.spite:type_name -> implantpb.Spite
	109, // 55: clientpb.SpiteResponse.spite:type_name -> implantpb.Spite
	...
	95,  // 59: clientpb.Pipeline.secure:type_name -> clientpb.Secure
	...
	99,  // 71: clientpb.AcmeConfig.credentials:type_name -> clientpb.AcmeConfig.CredentialsEntry
	100, // 72: clientpb.AcmeRequest.credentials:type_name -> clientpb.AcmeRequest.CredentialsEntry
	101, // 73: clientpb.REM.agents:type_name -> clientpb.REM.AgentsEntry
	70,  // 74: clientpb.REMAgents.agents:type_name -> clientpb.REMAgent
	102, // 75: clientpb.Website.contents:type_name -> clientpb.Website.ContentsEntry
	...
	80,  // 78: clientpb.BuildConfig.resources:type_name -> clientpb.BuildResources
	82,  // 79: clientpb.BuildConfig.docker:type_name -> clientpb.DockerBuildConfig
	83,  // 80: clientpb.BuildConfig.github_action:type_name -> clientpb.GithubActionBuildConfig
	84,  // 81: clientpb.BuildConfig.saas:type_name -> clientpb.SaasBuildConfig
	81,  // 82: clientpb.BuildResources.entries:type_name -> clientpb.ResourceEntry
	103, // 83: clientpb.GithubActionBuildConfig.inputs:type_name -> clientpb.GithubActionBuildConfig.InputsEntry
	104, // 84: clientpb.SaasBuildConfig.headers:type_name -> clientpb.SaasBuildConfig.HeadersEntry
	88,  // 85: clientpb.GithubWorkflows.workflows:type_name -> clientpb.GithubWorkflow
	...
	91,  // 90: clientpb.Contexts.contexts:type_name -> clientpb.Context
	91,  // 91: clientpb.ContextChunk.header:type_name -> clientpb.Context
	94,  // 92: clientpb.Secure.server_keypair:type_name -> clientpb.KeyPair
	94,  // 93: clientpb.Secure.implant_keypair:type_name -> clientpb.KeyPair
...
func file_client_clientpb_client_proto_init() {
	...
	file_client_clientpb_client_proto_msgTypes[79].OneofWrappers = []interface{}{
