module github.com/chainreactors/IoM-go/example

go 1.20

replace github.com/chainreactors/IoM-go => ../

require github.com/chainreactors/IoM-go v0.0.0
...
require (
	...
	github.com/chainreactors/tui v0.0.0-20250825071101-9e61744e554f // indirect
